    ...
    <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-side">
            ...
            <label className="cursor-pointer grid justify-center place-items-center ">
                <input type="checkbox" value="coffee" className="toggle theme-controller bg-amber-300 border-sky-400 [--tglbg:theme(colors.sky.500)] checked:bg-blue-300 checked:border-blue-800 checked:[--tglbg:theme(colors.blue.900)] row-start-1 col-start-1 col-span-2"/>
