...
api.add_resource(EventsById, '/apis/<uuid:id>')
...
api.add_resource(CheckDisplayName, '/<x>/api/check_user/<display_name>', endpoint='check_user')
api.add_resource(CheckSession, '/<x>/api/check_session', endpoint='check_session')
api.add_resource(Login, '/api/login', endpoint='login')
api.add_resource(Logout, '/<x>/api/logout', endpoint='logout')
